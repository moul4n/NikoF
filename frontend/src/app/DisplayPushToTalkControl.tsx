 ...
 * useSttState seam for start/stop semantics. The microphone itself is chosen on
 * the control page and saved globally; useSttState re-applies that selection
 * here automatically, so there is no device picker on the display surface.
 */
