...
exports.DEFAULT_BASE_ANIMATION_COMMAND = void 0;
exports.buildSharedSemanticAnimationPayloadCatalogFromRuntimeDocuments = buildSharedSemanticAnimationPayloadCatalogFromRuntimeDocuments;
exports.cloneDefaultBaseAnimationCommand = cloneDefaultBaseAnimationCommand;
exports.resolveSharedSemanticAnimationPayload = resolveSharedSemanticAnimationPayload;
exports.resolveSharedSemanticAnimationPayloadFromRuntimeDocuments = resolveSharedSemanticAnimationPayloadFromRuntimeDocuments;
const idle_default_runtime_json_1 = __importDefault(require("../../../../assets/animations/generated/shared/idle.default/idle.default.runtime.json"));
const gesture_punch_once_runtime_json_1 = __importDefault(require("../../../../assets/animations/generated/shared/gesture.punch.once/gesture.punch.once.runtime.json"));
const listen_loop_runtime_json_1 = __importDefault(require("../../../../assets/animations/generated/shared/listen.loop/listen.loop.runtime.json"));
const speak_loop_runtime_json_1 = __importDefault(require("../../../../assets/animations/generated/shared/speak.loop/speak.loop.runtime.json"));
const sharedAnimationRuntimeSidecarModules = {
    "idle.default": {
        default: idle_default_runtime_json_1.default
    },
    "gesture.punch.once": {
        default: gesture_punch_once_runtime_json_1.default
    },
    "listen.loop": {
        default: listen_loop_runtime_json_1.default
    },
    "speak.loop": {
        default: speak_loop_runtime_json_1.default
    }
};
exports.DEFAULT_BASE_ANIMATION_COMMAND = {
    id: "idle.default",
    source: "shared",
    playback: "loop"
};
...
function buildSharedSemanticAnimationPayloadCatalogFromRuntimeDocuments(runtimeDocuments) {
...
function cloneDefaultBaseAnimationCommand() {
    return {
        ...exports.DEFAULT_BASE_ANIMATION_COMMAND
    };
}
function resolveSharedSemanticAnimationPayload(command) {
    return resolveSharedSemanticAnimationPayloadFromCatalog(command, sharedSemanticAnimationPayloadCatalog);
}
function resolveSharedSemanticAnimationPayloadFromRuntimeDocuments(command, runtimeDocuments) {
